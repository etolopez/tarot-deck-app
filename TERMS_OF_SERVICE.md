...
By accessing or using Tarot Deck App ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you disagree with any part of these terms, you may not access the App.
...
- Reading history and personalization features

## Eligibility

You must be at least 13 years old to use this App. By using the App, you represent and warrant that you are at least 13 years old.

## User Accounts and Wallet Connection

### Wallet Connection

- You may connect a Solana wallet to access paid features
- You are responsible for maintaining the security of your wallet
- We are not responsible for any loss of funds due to wallet security issues
- You may disconnect your wallet at any time

### Account Responsibility

- You are responsible for all activities that occur under your wallet address
- You must immediately notify us of any unauthorized use of your wallet
- We are not liable for any losses resulting from unauthorized access

## Payments and Credits

### Credit System

- Credits are required to access tarot readings
- Credits are purchased using Solana (SOL) cryptocurrency
...
- All content, features, and functionality of the App are owned by Tarot Deck App
- The App's design, code, and content are protected by copyright and trademark laws
- You may not copy, modify, or distribute any part of the App without permission

### Your Content

- Readings generated using the App are your personal data
- We do not claim ownership of your reading results
- You retain all rights to your personal reading data
...
- Readings are NOT medical, legal, financial, or professional advice
- We do not guarantee the accuracy or reliability of readings
- You should not make important life decisions based solely on tarot readings
...
- We are not responsible for blockchain network issues or delays
- Cryptocurrency values are volatile and may fluctuate
...
- Our total liability shall not exceed the amount you paid for credits in the past 12 months
- We are not responsible for any loss of cryptocurrency or funds
- We are not liable for any decisions made based on tarot readings

## Indemnification

You agree to indemnify and hold harmless Tarot Deck App, its owners, employees, and affiliates from any claims, damages, losses, or expenses arising from:

- Your use of the App
- Your violation of these Terms
- Your violation of any rights of another party
- Your connection of a wallet or cryptocurrency transactions
...
These Terms constitute the entire agreement between you and Tarot Deck App regarding the use of the App.
...
By using Tarot Deck App, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
